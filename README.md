## move_base_sequence (noetic) - 0.0.1-1

The packages in the `move_base_sequence` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic move_base_sequence --edit` on `Sun, 21 Feb 2021 18:27:43 -0000`
...
## move_base_sequence (melodic) - 0.0.1-2

The packages in the `move_base_sequence` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic move_base_sequence --edit` on `Sun, 21 Feb 2021 18:20:37 -0000`
...
## move_base_sequence (melodic) - 0.0.1-1

The packages in the `move_base_sequence` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic move_base_sequence --edit` on `Sun, 21 Feb 2021 18:13:29 -0000`
...
## move_base_sequence (kinetic) - 0.0.1-6
